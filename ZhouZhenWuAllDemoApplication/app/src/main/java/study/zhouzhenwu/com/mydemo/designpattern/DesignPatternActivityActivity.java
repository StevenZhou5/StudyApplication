...
import study.zhouzhenwu.com.mydemo.designpattern.activity.DesignPatternBaseRuleActivity;
import study.zhouzhenwu.com.mydemo.designpattern.activity.DesignPatternChainOfResponsibility;
...
public class DesignPatternActivityActivity extends ActivityListActivity {
    ...
    private ActivityListItemBean[] mAllItemBeans = {
            new ActivityListItemBean("面向对象的基本原则", DesignPatternBaseRuleActivity.class),
            ...
            new ActivityListItemBean("责任链模式", DesignPatternChainOfResponsibility.class),
