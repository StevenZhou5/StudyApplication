...
def create_user_feature_model(features):
    ...
    # 进行全连接的神经网络搭建
    user_final_layer = layers.Dense(200)(user_concatenate)
...
def create_movie_feature_model(features, title_set, genres_set):
    ...
    # ===========进行全连接的神经网络搭建
    movie_final_layer = layers.Dense(200)(movie_concatenate)
...
def main():
    ...
    history = rate_predict_model.fit(
        ...
        train_targets_values, batch_size=256, epochs=200,
        validation_data=(
